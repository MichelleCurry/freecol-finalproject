...
public final class InGameInputHandler extends InputHandler {
    ...
    private Element animateAttack(Element element) {
        ...
        {
            throw new IllegalStateException(ATTACK_ANIMATION
        ...
        String defenderAttribute = element.getAttribute("defender");
        if (defenderAttribute.isEmpty()) {
            throw new IllegalStateException(ATTACK_ANIMATION + player.getId() + " missing defender attribute.");
        }
        ...
        String attackerTileAttribute = element.getAttribute("attackerTile");
        if (attackerTileAttribute.isEmpty()) {
            throw new IllegalStateException(ATTACK_ANIMATION + player.getId() + " missing attacker tile attribute.");
        }
        ...
        String defenderTileAttribute = element.getAttribute("defenderTile");
        if (defenderTileAttribute.isEmpty()) {
            throw new IllegalStateException(ATTACK_ANIMATION + player.getId() + " missing defender tile attribute.");
        }
